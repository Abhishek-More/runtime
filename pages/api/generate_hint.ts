...
export default async function handler(
  ...
  res: NextApiResponse<Data>
    ...
    try {
        ...
        const inputString = "I have this leetcode question: " + html_parsed + ". Please give me a json of short hints such that each hint is more helpful than the last for solving the question. The first hint should be vague with the last hint being very specific and revealing. The output format should be a json in this format {hint1: 'content of hint 1', hint2: 'content of hint 2'...}"
